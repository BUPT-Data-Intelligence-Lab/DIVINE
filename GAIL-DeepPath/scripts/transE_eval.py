# -*- coding: utf-8 -*-
# for link prediction evaluation using transE
import cPickle
import sys
import numpy as np
...
# TransE considers ent and rel are in the same space
# thus, TransE without transfer matrix
...
with open(link_results_path, 'a') as f:
    f.write('TransE MAP: ' + str(mean_ap) + '\n')
